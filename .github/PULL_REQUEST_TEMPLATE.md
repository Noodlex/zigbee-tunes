<!-- Thanks for contributing to Zigbee Tunes! -->

## What & why

Briefly describe the change and the problem it solves. Link any related
issue (`Fixes #123`).
...
Anything worth calling out (trade-offs, screenshots for UI changes, etc.).
